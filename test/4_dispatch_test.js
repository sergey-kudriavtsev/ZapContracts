...
contract('Dispatch', function (accounts) {
    ...
    it("DISPATCH_6 - respond1() - Respond check", async function () {
        ...
        expect(isEventReceived(logs, "LogIncoming")).to.be.equal(true);
    ...
    it("DISPATCH_7 - respond1() - Respond will throw error if it was called not from provider address", async function () {
    ...
    it("DISPATCH_8 - respond2() - Respond check", async function () {
    ...
    it("DISPATCH_9 - respond2() - Respond will throw error if it was called not from provider address", async function () {
    ...
    it("DISPATCH_10 - respond3() - Respond check", async function () {
    ...
    it("DISPATCH_11 - respond3() - Respond will throw error if it was called not from provider address", async function () {
    ...
    it("DISPATCH_12 - respond4() - Respond check", async function () {
    ...
    it("DISPATCH_13 - respond4() - Respond will throw error if it was called not from provider address", async function () {
